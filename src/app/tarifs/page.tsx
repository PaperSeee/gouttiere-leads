...
export const metadata: Metadata = {
  title: { absolute: "Tarifs Nettoyage Gouttières Bruxelles — Prix 2026" },
  description:
    "Prix pour le nettoyage, débouchage et réparation de gouttières à Bruxelles en 2026. Nettoyage dès 80€, débouchage dès 120€. Devis gratuit.",
