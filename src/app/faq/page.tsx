...
export const metadata: Metadata = {
  title: "FAQ Gouttières Bruxelles — 15 Questions & Réponses",
  description:
    "Toutes les réponses sur le nettoyage de gouttières à Bruxelles : prix, fréquence, risques, urgences, matériaux. Expert au 0451 05 33 70.",
