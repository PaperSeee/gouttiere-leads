...
export const metadata: Metadata = {
  title: { absolute: "FAQ Nettoyage Gouttières Bruxelles" },
  description:
    "Toutes les réponses à vos questions sur le nettoyage de gouttières à Bruxelles : prix, fréquence, risques, urgences. Expert au 0451 05 33 70.",
