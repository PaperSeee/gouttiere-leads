...
export const metadata: Metadata = {
  title: { absolute: "Nettoyage Gouttières Bruxelles-Ville — Pentagone & Immeubles" },
...
export default function BruxellesPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "FAQPage",
            mainEntity: bruxellesFaqs.map((f) => ({
              "@type": "Question",
              name: f.q,
      ...
      />
      <Breadcrumb items={[{ label: "Accueil", href: "/" }, { label: "Communes" }, { label: "Bruxelles-Ville" }]} />
