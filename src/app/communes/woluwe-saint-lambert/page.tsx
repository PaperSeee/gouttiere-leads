...
export const metadata: Metadata = {
  title: { absolute: "Nettoyage Gouttières Woluwe-Saint-Lambert — Villas" },
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "Nettoyage gouttières Woluwe-Saint-Lambert" }],
  },
}

const woluweStLambertFaqs = [
...
export default function WoluweStLambertPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "FAQPage",
            mainEntity: woluweStLambertFaqs.map((f) => ({
              "@type": "Question",
              name: f.q,
      ...
      />
      <Breadcrumb items={[{ label: "Accueil", href: "/" }, { label: "Communes" }, { label: "Woluwe-Saint-Lambert" }]} />
