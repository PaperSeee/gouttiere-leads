...
export const metadata: Metadata = {
  title: { absolute: "Nettoyage Gouttières Molenbeek-Saint-Jean — Canal" },
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "Nettoyage gouttières Molenbeek" }],
  },
}

const molenbeekSaintJeanFaqs = [
...
export default function MolenbeekSaintJeanPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "FAQPage",
            mainEntity: molenbeekSaintJeanFaqs.map((f) => ({
              "@type": "Question",
              name: f.q,
      ...
      />
      <Breadcrumb items={[{ label: "Accueil", href: "/" }, { label: "Communes" }, { label: "Molenbeek-Saint-Jean" }]} />
      ...
      <section className="py-14 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-5">
            {molenbeekSaintJeanFaqs.map((faq, i) => (
