...
export const metadata: Metadata = {
  title: { absolute: "Nettoyage Gouttières Berchem-Sainte-Agathe — Villas" },
...
export default function BerchemSainteAgathePage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "FAQPage",
            mainEntity: berchemSainteAgatheFaqs.map((f) => ({
              "@type": "Question",
              name: f.q,
      ...
      />
      <Breadcrumb items={[{ label: "Accueil", href: "/" }, { label: "Communes" }, { label: "Berchem-Sainte-Agathe" }]} />
      ...
      <section className="py-14 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-5">
            {berchemSainteAgatheFaqs.map((faq, i) => (
