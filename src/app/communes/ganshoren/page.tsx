...
export const metadata: Metadata = {
  title: { absolute: "Nettoyage Gouttières Ganshoren — Commune Résidentielle" },
...
export default function GanshorenPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "FAQPage",
            mainEntity: ganshorenFaqs.map((f) => ({
              "@type": "Question",
              name: f.q,
      ...
      />
      <Breadcrumb items={[{ label: "Accueil", href: "/" }, { label: "Communes" }, { label: "Ganshoren" }]} />
