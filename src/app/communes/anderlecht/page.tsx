...
export const metadata: Metadata = {
  title: { absolute: "Nettoyage Gouttières Anderlecht — Maisons Ouvrières & Canaux" },
...
export default function AnderlechtPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "FAQPage",
            mainEntity: anderlechtFaqs.map((f) => ({
              "@type": "Question",
              name: f.q,
      ...
      />
      <Breadcrumb items={[{ label: "Accueil", href: "/" }, { label: "Communes" }, { label: "Anderlecht" }]} />
