...
export const metadata: Metadata = {
  title: { absolute: "Nettoyage Gouttières Evere — OTAN & Quartiers Résidentiels" },
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "Nettoyage gouttières Evere" }],
  },
}
...
export default function EverePage() {
  return (
    <>
      ...
      />
      <Breadcrumb items={[{ label: "Accueil", href: "/" }, { label: "Communes" }, { label: "Evere" }]} />
