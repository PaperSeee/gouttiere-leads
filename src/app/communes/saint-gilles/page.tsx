...
export const metadata: Metadata = {
  title: { absolute: "Nettoyage Gouttières Saint-Gilles — Art Nouveau" },
...
export default function SaintGillesPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "FAQPage",
            mainEntity: saintGillesFaqs.map((f) => ({
              "@type": "Question",
              name: f.q,
      ...
      />
      <Breadcrumb items={[{ label: "Accueil", href: "/" }, { label: "Communes" }, { label: "Saint-Gilles" }]} />
