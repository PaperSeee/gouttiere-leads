...
export const metadata: Metadata = {
  title: { absolute: "Nettoyage Gouttières Jette — Villas & Parc de Laeken" },
  ...
  openGraph: {
    title: "Nettoyage Gouttières Jette — Devis Gratuit | 0451 05 33 70",
...
export default function JettePage() {
  return (
    <>
      ...
      />
      <Breadcrumb items={[{ label: "Accueil", href: "/" }, { label: "Communes" }, { label: "Jette" }]} />
