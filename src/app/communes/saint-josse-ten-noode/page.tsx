...
export const metadata: Metadata = {
  title: { absolute: "Nettoyage Gouttières Saint-Josse-ten-Noode — Immeubles" },
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "Nettoyage gouttières Saint-Josse" }],
  },
}

const saintJosseFaqs = [
...
export default function SaintJossePage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "FAQPage",
            mainEntity: saintJosseFaqs.map((f) => ({
              "@type": "Question",
              name: f.q,
      ...
      />
      <Breadcrumb items={[{ label: "Accueil", href: "/" }, { label: "Communes" }, { label: "Saint-Josse-ten-Noode" }]} />
