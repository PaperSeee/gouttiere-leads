...
export const metadata: Metadata = {
  title: "Nettoyage Gouttières Schaerbeek — Maisons Belle Époque | 0451 05 33 70",
    ...
    <>
      ...
      <section id="devis" className="py-14 bg-white">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6 sm:p-8"><ContactForm defaultCommune="Schaerbeek" /></div>
        </div>
      </section>
