...
export const metadata: Metadata = {
  title: { absolute: "Nettoyage Gouttières Koekelberg — Basilique" },
...
export default function KoekelbergPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "FAQPage",
            mainEntity: koekelbergFaqs.map((f) => ({
              "@type": "Question",
              name: f.q,
      ...
      />
      <Breadcrumb items={[{ label: "Accueil", href: "/" }, { label: "Communes" }, { label: "Koekelberg" }]} />
