...
export const metadata: Metadata = {
  title: { absolute: "Nettoyage Gouttières Forest — Maisons Mitoyennes & Cottages" },
...
export default function ForestPage() {
  return (
    <>
      ...
      />
      <Breadcrumb items={[{ label: "Accueil", href: "/" }, { label: "Communes" }, { label: "Forest" }]} />
