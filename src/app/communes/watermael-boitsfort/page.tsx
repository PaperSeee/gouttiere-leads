...
export const metadata: Metadata = {
  title: { absolute: "Nettoyage Gouttières Watermael-Boitsfort — Cités-Jardins" },
  ...
  openGraph: {
    title: "Nettoyage Gouttières Watermael-Boitsfort — Devis Gratuit | 0451 05 33 70",
...
export default function WatermealBoitsfortPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "FAQPage",
            mainEntity: watermealBoitsfortFaqs.map((f) => ({
              "@type": "Question",
              name: f.q,
      ...
      />
      <Breadcrumb items={[{ label: "Accueil", href: "/" }, { label: "Communes" }, { label: "Watermael-Boitsfort" }]} />
      ...
      <section className="py-14 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-5">
            {watermealBoitsfortFaqs.map((faq, i) => (
