...
export const metadata: Metadata = {
  title: { absolute: "Nettoyage Gouttières Etterbeek — Immeubles & Maisons" },
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "Nettoyage gouttières Etterbeek" }],
  },
}
...
export default function EtterbeekPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "FAQPage",
            mainEntity: etterbeekFaqs.map((f) => ({
              "@type": "Question",
              name: f.q,
      ...
      />
      <Breadcrumb items={[{ label: "Accueil", href: "/" }, { label: "Communes" }, { label: "Etterbeek" }]} />
