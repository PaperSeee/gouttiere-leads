...
export const metadata: Metadata = {
  title: "Types de Gouttières : Zinc, PVC, Alu, Cuivre — Guide",
  description:
    "Guide des types de gouttières : zinc, PVC, aluminium et cuivre. Avantages, prix et durée de vie pour choisir le bon matériau à Bruxelles.",
