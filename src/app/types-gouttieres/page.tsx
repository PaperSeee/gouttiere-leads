...
export const metadata: Metadata = {
  title: { absolute: "Types de Gouttières : Zinc, PVC, Aluminium, Cuivre" },
  description:
    "Guide des types de gouttières : zinc, PVC, aluminium et cuivre. Avantages, inconvénients, prix et durée de vie. Choisissez le bon matériau.",
