...
export const metadata: Metadata = {
  title: { absolute: "Infiltrations d'Eau sur Façade : le Rôle des Gouttières" },
  description: "Taches d'humidité, moisissures, peinture qui s'écaille : les gouttières défectueuses sont souvent en cause. Diagnostic et solutions à Bruxelles.",
