...
export const metadata: Metadata = {
  title: "Infiltrations d'Eau sur Façade : Rôle des Gouttières",
  description: "Taches d'humidité, moisissures, peinture écaillée : les gouttières défectueuses sont souvent en cause. Diagnostic et solutions pour votre façade.",
