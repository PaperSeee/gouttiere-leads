...
export const metadata: Metadata = {
  title: "Protections Anti-Feuilles pour Gouttières à Bruxelles",
  description: "Grilles, brosses, filets ou mousses : comparatif des protections anti-feuilles pour gouttières à Bruxelles. Avantages, limites, prix et efficacité réelle.",
