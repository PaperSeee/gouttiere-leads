...
export const metadata: Metadata = {
  title: "Protections Anti-Feuilles Gouttières : Grilles ou Filets ?",
  description: "Grilles, brosses, filets pour gouttières à Bruxelles : avantages, limites, prix et efficacité réelle pour espacer les nettoyages.",
