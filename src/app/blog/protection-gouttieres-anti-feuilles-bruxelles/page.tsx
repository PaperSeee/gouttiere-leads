...
export const metadata: Metadata = {
  title: "Protections Anti-Feuilles Gouttières : Que Choisir ?",
  description: "Grilles, brosses, filets : comparatif des protections anti-feuilles pour gouttières à Bruxelles. Avantages, limites, prix et efficacité réelle.",
