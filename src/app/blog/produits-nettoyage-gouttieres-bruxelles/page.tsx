...
export const metadata: Metadata = {
  title: "Produits Nettoyage Gouttières Bruxelles : Que Choisir ?",
  description: "Guide des produits pour nettoyer vos gouttières à Bruxelles : démoussants, dégraissants, anti-algues. Ce qui fonctionne et ce qui abîme vos gouttières.",
