...
export const metadata: Metadata = {
  title: "Zinc, PVC ou Alu : Quel Matériau pour ses Gouttières ?",
  description: "Comparatif zinc, PVC, aluminium et cuivre pour vos gouttières à Bruxelles : durée de vie, entretien, coût et compatibilité.",
