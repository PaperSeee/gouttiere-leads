...
export const metadata: Metadata = {
  title: { absolute: "Orages d'été à Bruxelles : la checklist gouttières" },
  description: "Un orage d'été déverse en 20 minutes l'équivalent de plusieurs jours de pluie. La checklist pour préparer vos gouttières avant l'orage à Bruxelles.",
