...
export const metadata: Metadata = {
  title: "Gouttière qui Déborde : Causes, Dangers, Solutions",
  description: "Gouttière qui déborde sous la pluie ? Les 6 causes les plus fréquentes, les risques pour votre maison et les gestes à faire immédiatement.",
