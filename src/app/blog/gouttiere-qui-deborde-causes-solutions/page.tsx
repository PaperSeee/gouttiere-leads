...
export const metadata: Metadata = {
  ...
  description: "Gouttière qui déborde sous la pluie ? Les 6 causes fréquentes, les risques pour votre maison et les gestes à faire immédiatement. Urgence 7j/7 à Bruxelles.",
