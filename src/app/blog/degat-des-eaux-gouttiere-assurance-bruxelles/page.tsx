...
export const metadata: Metadata = {
  title: "Dégât des Eaux dû à une Gouttière : Assurance ?",
  description: "Une gouttière bouchée a causé un dégât des eaux ? Ce que couvre (ou non) votre assurance habitation à Bruxelles, et comment éviter un refus.",
