...
export const metadata: Metadata = {
  ...
  description: "Gel, glace et neige fondue endommagent les gouttières l'hiver à Bruxelles. Risques (fissures, descentes bouchées, barrières de glace) et comment les protéger.",
