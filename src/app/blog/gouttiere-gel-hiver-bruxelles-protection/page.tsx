...
export const metadata: Metadata = {
  title: { absolute: "Gouttières et Gel en Hiver à Bruxelles" },
  description: "Gel, glace et neige fondue endommagent les gouttières en hiver à Bruxelles. Risques (fissures, descentes bouchées, barrières de glace) et protection.",
