...
export const metadata: Metadata = {
  ...
  description: "Gel et neige fondue endommagent les gouttières en hiver à Bruxelles. Découvrez les risques (fissures, descentes bouchées) et comment les protéger du froid.",
