...
export const metadata: Metadata = {
  ...
  description: "Tout savoir sur le nettoyage de gouttières à Bruxelles : fréquence, prix du marché, risques d'une gouttière bouchée et comment trouver un pro fiable.",
