...
export const metadata: Metadata = {
  title: "Démoussage de Toiture à Bruxelles : Quand et à Quel Prix",
  description: "Mousses et lichens sur le toit ? Quand faire un démoussage à Bruxelles, méthodes professionnelles, prix 2026 et lien avec l'entretien des gouttières.",
