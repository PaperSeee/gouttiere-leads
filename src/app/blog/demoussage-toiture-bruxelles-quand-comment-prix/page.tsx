...
export const metadata: Metadata = {
  title: "Démoussage Toiture Bruxelles : Quand, Comment, Prix",
  description: "Mousses et lichens sur votre toit ? Quand faire un démoussage à Bruxelles, méthodes professionnelles, prix 2026 et lien avec vos gouttières.",
