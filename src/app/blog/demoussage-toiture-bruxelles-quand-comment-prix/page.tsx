...
export const metadata: Metadata = {
  title: { absolute: "Démoussage de Toiture à Bruxelles : Guide Complet 2026" },
  description: "Mousses, lichens et algues sur votre toit ? Quand faire un démoussage à Bruxelles, méthodes professionnelles, prix 2026 et lien avec vos gouttières.",
