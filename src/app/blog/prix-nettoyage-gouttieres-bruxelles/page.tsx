...
export const metadata: Metadata = {
  ...
  description: "Combien coûte un nettoyage de gouttières à Bruxelles ? Tarifs 2026 selon le type de maison, comparaison DIY vs professionnel, prestation incluse.",
