      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <address className="not-italic space-y-2 text-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="tel:0451053370" className="hover:text-white transition-colors">
                  0451 05 33 70
                </a>
              </div>
              <div className="flex items-center gap-2">
              ...
              {communes.map((c) => (
                <li key={c.slug}>
                  <Link
                    ...
                    className="hover:text-accent transition-colors py-1 block"
                  >
                    Gouttières {c.name}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-sm">
              <li>
                <Link href="/services/nettoyage-gouttieres" className="hover:text-accent transition-colors">
                  Nettoyage gouttières
                </Link>
              </li>
              <li>
                <Link href="/services/debouchage-gouttieres" className="hover:text-accent transition-colors">
                  Débouchage urgence
                </Link>
              </li>
              <li>
                <Link href="/services/reparation-gouttieres" className="hover:text-accent transition-colors">
                  Réparation / remplacement
                </Link>
              </li>
              <li>
                <Link href="/services/demoussage-toiture" className="hover:text-accent transition-colors">
                  Démoussage toiture
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="mt-6 p-3 bg-brand-deep rounded-lg text-sm">
